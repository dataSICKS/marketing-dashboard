  ...
  return (
    <div className="flex flex-col h-full" style={{ background: "#0a0a0a" }}>
      ...
      >
        {!collapsed && (
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold" style={{ color: "#fff" }}>Mail Analytics</span>
          </div>
        )}
        {collapsed && (
      ...
      <nav className="flex-1 p-2 flex flex-col gap-0.5 overflow-y-auto overflow-x-hidden">
        {!collapsed && (
          <div className="px-3 py-2 text-[10px] font-semibold" style={{ color: "#444", letterSpacing: "0.1em" }}>分析</div>
        )}
          ...
          return (
            <Link
              ...
              style={{
                ...
                color: active ? YELLOW_DARK : "#6B7280",
                fontWeight: active ? 600 : 400,
              }}
            >
              <Icon size={16} color={active ? YELLOW_DARK : "#666"} />
        ...
        {!collapsed && (
          <div className="px-3 py-2 text-[10px] font-semibold mt-2" style={{ color: "#444", letterSpacing: "0.1em" }}>設定</div>
        )}
